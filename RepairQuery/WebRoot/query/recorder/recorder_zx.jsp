...
<script type="text/javascript">
	...
	function CreatePrintPage(){
		...
		LODOP.ADD_PRINT_TEXT(21,300,200,30,"${unitType}${flowval }检修记录\n");
 ...
 <tr>
	...
	<table width="864" border="0" align="center" cellspacing="0" vspace="0" id="datatabel">
		<tr style="line-height:40px;height: 40px;background-color: #328aa4;font-weight: bolder;">
			...
			<td class="tbCELL1" align="center" style="white-space:nowrap;color:#ffffff;" width="6%">检修/探伤人</td>
 		...
 		<c:forEach items="${jczxFixRecs}" var="item">
		<tr>
			...
			<c:if test="${item.nodeId==101 && !empty item.upPjNum}">
			      <c:forTokens items="${item.upPjNum }" delims="," var="num">
					<a href="recorderAction!findPjRecordByPjNum.action?rjhmId=${datePlan.rjhmId}&pjNum=${num}" target="_blank">${num }</a>&nbsp;
				</c:forTokens>
			</c:if>
			</td>
			<td class="tbCELL1" align="center">
