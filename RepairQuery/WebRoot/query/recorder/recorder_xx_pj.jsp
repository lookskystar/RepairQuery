...
<script language="JavaScript" type="text/javascript">
   $(function(){
	...
	function SaveAsFile(){ 
		...
		LODOP.SAVE_TO_FILE("${datePlan.jcType }-${datePlan.jcnum }-${datePlan.fixFreque}-整车配件检修记录.xls"); 
	};	
	...
	function CreatePrintPage(){
		...
		LODOP.ADD_PRINT_TEXT(21,300,300,30,"${datePlan.jcType }-${datePlan.jcnum }整车配件记录记录\n");
...
<ul id="nav">
    ...
    <li><a href="<%=basePath%>recorderAction!findXXJCPJ.action?rjhmId=${datePlan.rjhmId}&jwdCode=${jwdCode}" style="background-color:#fff;color:blue;">◇配件记录</a></li>
