...
<ul id="nav">
    ...
    <li><a href="<%=basePath %>recorderAction!getAllInfoPre.action?rjhmId=${datePlan.rjhmId}&jwdCode=${jwdCode}" style="background-color:#fff;color:blue;">◇报活记录</a></li>
							...
							<table width="890" border="0" align="center" cellspacing="0" id="datatabel">
								...
								<c:forEach items="${preDictRecs}" var="preItem">
									<tr>
										...
										<td class="tbCELL1" align="center" name="proteam">${preItem.proTeamId }&nbsp;</td>
										<td class="tbCELL1" align="center">${fn:replace(preItem.repPosi,',','/') }/${preItem.repsituation }&nbsp;</td>
